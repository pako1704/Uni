...
public final class Terminal {
   ...
   * {@code String} array, whereas the first array field contains the file's
  ...
  public static String[] readFile(final String path) {
    try (final BufferedReader reader = new BufferedReader(new FileReader(path))) {
       ...
       * file-paths. Therefore there will no IOException occur while reading in
       * files during the tests, the following RuntimeException does not have to
       * get handled.
       */
      throw new RuntimeException(e);
    }
